...
<html>
    ...
    <body>
        ...
        <form action="forgot" method="post" class="">
            ...
            <label><strong>Email: </strong></label><input type="email" name="username_input" <c:out value=""></c:out>><br><br>
                <input type="submit" class="btn btn-primary btn-lg btn-block" id="BTNS" value="Reset password">
                <br>
