        ...
        <header class="loginHeader">
            ...
            <table class="navi">
                <tr>
                    ...
                    <td class="roll"><a href="employee">Employee Page</a></td>
            ...
            <div class="form-group">
                    ...
                    <div class="responsive">
                        <table class="forms2">
                            <tr>
                                ...
                                <td>
                                    <select name="itemType" id="itemType" class="type">
                ...
                <c:if test="${selectedType != null}">
                    <form method="post">
                        ...
                        <br>
                        <input type="submit" name="action" id="addbutton2" class="btn btn-primary" value="Add">
                    </form>
                </c:if>
                <br>
            </div>
